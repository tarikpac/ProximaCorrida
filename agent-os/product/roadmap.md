...
19. [x] **Multi-Provider Scraper Architecture** — Refactor scraper to fetch events directly from providers (TicketSports, Zenite, Doity, Sympla, Ticket Agora, MinhaInscrição, etc.) instead of aggregators like corridasemaratonas.com.br. Implement modular per-platform scrapers, automatic event discovery by region/state, and multi-source data consolidation. `XL` ✅ **DONE: 2025-12-09**
